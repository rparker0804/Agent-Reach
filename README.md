...
[OpenMontage](https://github.com/calesthio/OpenMontage) — 开源 agentic 视频生产系统；可用 Agent Reach 采集的调研素材作为其 `research_brief` 输入（见 [`examples/openmontage_research_brief.py`](examples/openmontage_research_brief.py)）。
